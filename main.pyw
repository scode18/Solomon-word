...
class MainWindow(QMainWindow):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.setStyleSheet("background-color: rgb(48,56,65);")
    ...
    def update_title(self):
        self.setWindowTitle("%s - Solomon Word" % (os.path.basename(self.path) if self.path else "Untitled"))
...
if __name__ == '__main__':
    ...
    app.setApplicationName("Solomon Word")
